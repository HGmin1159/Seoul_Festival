...
[자연어 처리 참고](github.com/HGmin1159/Seoul_Festival/keyword/untitled.ipynb)  
...
[참고](github.com/HGmin1159/Seoul_Festival/keyword/untitled.ipynb)
...
```
 ...
 [참고 - 축제 클러스터 결과물](github.com/HGmin1159/Seoul_Festival/modeling/축제 클러스터 결과물.rmd)
...
[ 남성 이용자 비율 예측 파일 ]
- [전처리](modeling/Man proportion prediction/데이터 전처리.jpynb)
- [모델링](modeling/Man proportion prediction/남성비율예측+변수중요도.html)
